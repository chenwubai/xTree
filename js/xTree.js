...
(function(window) {
    ...
    xTree.prototype.extend({
        init: function(container) {
            ...
            this.svgWidth = getWidth(container.node());
            this.svgHeight = getHeight(container.node());
        ...
        calculate: function(config, originalData) {
            ...
            var tree = d3.layout.tree()
                .size([_self.svgWidth, _self.svgHeight]);
        ...
        render: function() {
            ...
            _self.main = this.svg.append('g')
                .classed('main', true)
                .attr('transform', 'translate(' + (_self.svgWidth-_self.secondBtmWidth)/2 + ',' + this.config.margin.top + ')');
            // 添加连线
        ...
        svgReady: function() {
            var _self = this;
            var mainOffset = [ (_self.svgWidth-_self.secondBtmWidth)/ 2, _self.config.margin.top],
                isDown = false;
            // 拖动查看可见区域外的结构
